    ...
    <header className="sticky top-0 z-30 border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
      <div className="flex items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <div className="flex items-center gap-2.5 rounded-xl border border-gray-200 px-3 py-1.5 dark:border-gray-700">
          ...
          <button
            ...
            disabled={loggingOut}
            className="flex items-center gap-1.5 rounded-lg border border-gray-200 px-3 py-2 text-sm font-medium text-gray-600 transition hover:border-gray-300 hover:bg-gray-50 disabled:opacity-60 dark:border-gray-700 dark:text-gray-300 dark:hover:border-gray-600 dark:hover:bg-gray-800"
          >
        ...
        >
          <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#F97316] text-sm font-bold text-white">
            {initials}
          </span>
        </button>
      </div>
      ...
      {menuOpen && (
        <div className="border-t border-gray-100 bg-white px-4 py-3 md:hidden dark:border-gray-800 dark:bg-gray-900">
          ...
          <button
            onClick={handleLogout}
            disabled={loggingOut}
            className="w-full rounded-lg bg-gray-100 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-200 disabled:opacity-60 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
          >
            {loggingOut ? "Signing out…" : "Sign out"}
          </button>
        </div>
