...
| [`FRONTEND_PLAN.md`](documentation/planning/FRONTEND_PLAN.md) | **Every page, in one register.** The four surfaces — public directory, auth, partner back office, staff admin — with audience, phase, build status and a pointer to each page's spec. 43 built, 29 to come | New — statuses measured 2026-08-17 |
